...
In preparation for your workshop it is needed that you run a few commands to set everything up.

## Ensure the readiness of your system
...
```bash
## Get the code
git clone https://github.com/workshops-de/angular-workshop.git
...
## Open the app
## You shall see a simple web page on http://localhost:4200
npm start -- --open
```
